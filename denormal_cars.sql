...
-- In denormal_cars.sql Create a query to get a list of all make_title values in the car_models table. Without any duplicate rows, this should have 71 results.
-- SELECT DISTINCT make_title
--   FROM car_models;
-- In denormal_cars.sql Create a query to list all model_title values where the make_code is 'VOLKS'. Without any duplicate rows, this should have 27 results.
-- SELECT DISTINCT model_title
--   FROM car_models
--   WHERE make_code = 'VOLKS';

-- -- In denormal_cars.sql Create a query to list all make_code, model_code, model_title, and year from car_models where the make_code is 'LAM', Without any duplicate rows, this should have 136 rows.
